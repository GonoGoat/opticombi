...
int main()
{
    ...
    //Paramètres Parsage
    std::string nom_fichier = "Chemin_Anti_Tank.lt4";
    int matrice[16][16];
    int nbr_arrive = 0;
    ...
    std::string sequence = "LLLUURRRUUULLRRUULLUULLLLLLUURRUUUULLUUURRRDDLLLDDDRRRRDDDDDRRRUUUULLDDLLDDDRRRUUUUUURRRRRRDDDD";
